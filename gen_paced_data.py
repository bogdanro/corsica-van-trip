...
TITLE = {
 ...
 ("filitosa","propriano"):     ("Filitosa and the Gulf of Valinco", "Menhirs, then a working port",
   "Four-thousand-year-old carved faces in an olive grove, then down to Propriano to restock, eat on the quay and watch the best sunset on this coast."),
 ("rondinara","santagiulia"):  ("Two lagoons", "Shallow, translucent, and no hurry",
   "Rondinara's near-circular bay in the morning before the wind, Santa Giulia in the afternoon. Two of the three beaches every guide names."),
 ("palombaggia","portovecchio"): ("Palombaggia and the salt town", "Red rocks, umbrella pines, an evening in town",
   "The most photographed beach on the island early, then the walled upper town of Porto-Vecchio for an aperitif once the heat goes."),
 ("ospedale","piscia"):        ("Up into the Ospedale", "Out of the heat, into the pines",
   "Nine hundred metres of climb out of the beaches, a reservoir in granite, and the walk over slabs to a waterfall dropping into a chasm."),
 ("bavella","aiguilles"):      ("Col de Bavella", "Seven needles",
   "At the col for first light. The Trou de la Bombe is the gentle option; the Alpine loop on fixed chains is the real thing."),
 ("solenzara","ghisoni","aleria"): ("Down to the sea, and the road home", "River pools, an empty pass, the Romans",
   "The hairpins down to Solenzara, then the D69 that nobody drives, and the Greek and Roman capital above its lagoon."),
 ("pianella","calanches","piana"): ("The Spelunca and the Calanches", "A Genoese bridge and red granite",
   "A swim under the arch at Pianella, then the Calanches on foot — the shapes only work when you walk them — and Piana's balcony above the gulf."),
 ("caporosso","arone"):        ("Capo Rosso, then Arone", "A tower on a cliff, then sand",
   "8.5 km out along the headland to the Genoese tower, no shade at all. Then the beach at the end of the dead-end road, and nothing else."),
 ("scandola","porto"):         ("Scandola by boat, then Porto", "Red cliffs and a Genoese tower",
   "A half-day on the water into the reserve, usually with a stop at Girolata, then back to climb the tower on its rock."),
 ("aruda","asco"):             ("A Ruda and the Asco valley", "Granite chutes and a dead-end gorge",
   "Sculpted pools where the Golo leaves the lake, then twenty-five kilometres up a valley that ends under Monte Cinto."),
 ("ajaccio","sanguinaires"):   ("Ajaccio and the Sanguinaires", "The capital, and red islands",
   "Maison Bonaparte and the Fesch in the morning, the Place Foch market, then out to the Parata headland for the light."),
 ("vizzavona",):               ("Vizzavona", "A short day in the beech forest",
   "Deliberately gentle the day after Melo. The Cascade des Anglais, cool air at 900 m, and an early night."),
 ("spusata","tolla"):          ("The Bridal Veil and Lac de Tolla", "Waterfall, then a green reservoir",
   "Snowmelt off a granite face in the morning, then the twisting road down to Tolla to swim and eat by the water."),
